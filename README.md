...
<p>
Building 5 apps to practice my web dev skills.
</p>
...
| ID | Project Name | Core Complexity | Status |
| :--- | :--- | :--- | :--- |
| **01** | **Todo List App** | State Management | **COMPLETE** |
| **02** | **Crypto Dashboard** | API | **COMPLETE** |
| **03** | **Github Random Repo** | API | **IN PROGRESS** |
| **04** | **Weather Web App** | API | *Pending* |
| **05** | **Scalable E-Commerce Platform** | API | *Pending* |


## Dev Log & Architecture Notes

### The Foundation (Projects 1-2):
Solidify hooks and state management fundamentals.

> **Retrospective:** The Crypto Dashboard was significantly more complex than anticipated. Handling live market data required `useEffect` cleanup and error handling.
